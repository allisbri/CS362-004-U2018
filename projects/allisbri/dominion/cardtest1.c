...
int main() {
	...
	printf("\ntest 1: player 1 recieves 3 cards, other players do not recieve any\n");
	p1ExHandCount = handCount + 2; //accounting for discarded smithy
	...
	printf("\ntest 2: player 1's deck is down 3 cards, other players decks do not change\n");
	p1ExDeckCount = deckCount - 3;
	...
	printf("\ntest 4: cards from player1's deck added to hand");
	printf("Expected card1: %d  card2: %d card3: %d\n", deck[0], deck[1], deck[2]);
	printf("Actual card1: %d  card2: %d card3: %d\n", G.deck[0][4], G.deck[0][5], G.deck[0][6]);
	if(deck[0] == G.deck[0][4] && deck[1] == G.deck[0][5] && deck[2] == G.deck[0][6]){
